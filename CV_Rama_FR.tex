...
\section{Expériences}
\cventry{Septembre 2021 - Maintenant}{Développeur web}{Fleur de Papier}{CDD}{\textit{Développement d'applications interactives sur un framework MVC single-page / ou avec Vue.js {\linebreak \textbf{ Projets notables :}}} } {\begin{itemize}
	\item Jeux pédagogiques pour l'Atrium à Rouen
	\item Dispositifs interactifs pour la BNF
\end{itemize}} {}
...
\cventry{Mars 2019 - Juin 2019}{Projet}{IUT de Valence}{Valence}{\textit{Jeu de UNO en Java}}{Introduction à la programmation orientée objet et coopération en équipe.}


\section{Compétences}
\subsection{Développement}
\cvline{Front-end}{HTML/(S)CSS, JQuery, Javascript (ES6), GSAP, Vue.js, Three.js (débutant), React (notions)}
\cvline{Back-end}{PHP, Node.js, Django, SQL, MongoDB, Docker}
